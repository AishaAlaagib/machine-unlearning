...
train_data = np.load(os.path.join(pwd, 'new_adult_income_train.npy'), allow_pickle=True)
test_data = np.load(os.path.join(pwd, 'new_adult_income_test.npy'), allow_pickle=True)
