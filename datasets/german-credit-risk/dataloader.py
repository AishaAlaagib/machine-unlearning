...
train_data = np.load(os.path.join(pwd, 'german_credit_train.npy'), allow_pickle=True)
test_data = np.load(os.path.join(pwd, 'german_credit_test.npy'), allow_pickle=True)
