...
train_data = np.load(os.path.join(pwd, 'adult_income_train.npy'), allow_pickle=True)
test_data = np.load(os.path.join(pwd, 'adult_income_test.npy'), allow_pickle=True)
